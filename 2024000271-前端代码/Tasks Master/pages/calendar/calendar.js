  ...
  methods: {
    ...
    triggerEventSelectDay() {
      ...
      if (
        ...
        const selectDay = this.data.selectDay;
        const year = selectDay.year;
        const month = ('0' + selectDay.month).slice(-2);
        const day = ('0' + selectDay.day).slice(-2);
